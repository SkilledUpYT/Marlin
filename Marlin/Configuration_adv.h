...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 12*60, 5*60 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_RETRACT_SPEED   (5*60) // (mm/m) (Unloading)
    #define TOOLCHANGE_FS_UNRETRACT_SPEED (10*60) // (mm/m) (On SINGLENOZZLE or Bowden loading must be slowed down)

    // Longer prime to clean out a SINGLENOZZLE
    #define TOOLCHANGE_FS_EXTRA_PRIME          0  // (mm) Extra priming length
    #define TOOLCHANGE_FS_PRIME_SPEED    (3*60) // (mm/m) Extra priming feedrate
  ...
  #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY_FEEDRATE 4800  // (mm/m)
