...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (180)    // (seconds) Time without extruder movement to trigger protection
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 12*60, 5*60 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define SERVICE_NAME_1      "Service Printer"
